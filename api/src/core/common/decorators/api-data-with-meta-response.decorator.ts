...
export const ApiDataWithMetaResponse = <TData extends Type, TMeta extends Type>(args: ApiDataWithMetaResponseArgs<TData, TMeta>) =>
  applyDecorators(
...
export const ApiOkDataWithMetaResponse = <TData extends Type, TMeta extends Type>(args: Omit<ApiDataWithMetaResponseArgs<TData, TMeta>, 'status'>) =>
